...
export evensum, oddsum, altsum, diagsum, central
...
"""
Return the number of permutations of n letters, ``n! = ∏(1, n)``, the factorial of ``n``. (Nota: The notation is a shortcut breaking Julia naming conventions, used only internally.)
"""
