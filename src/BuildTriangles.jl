...
@info("The following modules are included in IntegerTriangles.jl:")
...
function build_seq()
    ...
    println(olm, "using Nemo, HTTP, DocStringExtensions, Test")
...
function build_test()
    ...
    println(o, "using Nemo, Test, IntegerTriangles")
    #println(o, "alia = joinpath(srcdir, \"Aliases.jl\")")
    #println(o, "include(alia)")
